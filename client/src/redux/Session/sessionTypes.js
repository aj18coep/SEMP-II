      ...
      .then((res) => {
        ...
        if (is_mentor) {
          ...
          axios
            ...
            .catch((err) => {
              alert("Cannot fetch the session requeests. Please refresh the page");
            });
          ...
          axios
            ...
            .catch((err) => {
              alert("Cannot fetch the upcoming sessions. Please refresh the page");
            });
          ...
          axios
            ...
            .catch((err) => {
              alert("Cannot fetch the sessions confirmations. Please refresh the page");
            });
