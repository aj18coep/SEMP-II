...
class Register extends Component {
      ...
      axios
        ...
        .then((response) => {
          if (response.data.affectedRows === 1) {
            ...
            if (this.state.is_mentor) {
              axios
                .post("http://localhost:5000/users/mentor", data)
                .then((res) => {
                  console.log("success");
                })
                .catch((err) => {
  ...
  handletype = (e) => {
    this.setState({
      type_selected: true,
      is_mentor:
        e.target[e.target.selectedIndex].value === "mentor" ? true : false,
    });
  };
              ...
              <div className="row" id="login-content">
                ...
                <div className="content-section col-12 col-md-7">
                  ...
                  <Form id="reg-form" onSubmit={this.handleSubmit}>
                    ...
                    {this.state.type_selected && this.state.is_mentor && (
                      <React.Fragment>
                        <FormGroup row>
                        ...
                        <FormGroup row>
                          <Label for="file" sm={12}>
                            Upload Proof of qualification (e.g. Resume or CV):
                          </Label>
                          <Input
                            type="file"
                            name="file"
